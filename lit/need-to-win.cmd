...
* 觴深：Shang-sh(e^)n  \+
    (Proper) name of a body of water. \+
      觴，音商，
      \C [^sh](oe)ng1 (\pm [_s](oe)ng1) \M sh(a-)ng
...
* 注：
    ...
    * [《南華真經\.郭象註》](
      ...
      ====
      * 之樹反：
          fan ((反))-.[pronunciation] chih shu ((之樹)) \+
    ...
    *
      疏，去聲，
      \C [^sh]or3 (\pm [_s]or3) \M sh(u\) (\gr sh(u-))
    ====
