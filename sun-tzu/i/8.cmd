...
%%
  %title "\sun-tzu's Computational Classic: Volume~I" ~~《孫子算經・卷上》~~ \P8
...
* After putting the numbers into two separate rows,
  ...
  ||||{centred-block}
    <svg class="fit-width" width="180px" viewBox="0.5 -0.5 5 3"
  ...
  ||||{centred-block}
    <svg class="fit-width" width="180px" viewBox="0.5 -0.7 5 2.8"
